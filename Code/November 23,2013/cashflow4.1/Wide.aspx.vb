...
Partial Class Report
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim reportPath As String = AppDomain.CurrentDomain.BaseDirectory + "Wide.rpt"
        ...
        'rpt.SetParameterValue("param_area", rArea)
        'rpt.SetParameterValue("param_branch", rBranch)
