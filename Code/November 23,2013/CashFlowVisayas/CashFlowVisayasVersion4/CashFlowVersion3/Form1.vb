...
Public Class Form1
    ...
    Private Sub insert_to_CF_vismin_wide()
        ...
        Dim ls_begbal As String = "select sum(beginningbalance) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_endingbal As String = "select sum(EndingBalance) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_foodproducts As String = "select sum(Foodproducts) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_insurance As String = "select sum(Insurance) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------jen 
        'updated by Arthur 6/17/2013
        'Dim ls_outrightsales As String = "select sum(outrightsales) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
        Dim ls_outrightsales As String = "select sum(outrightsales) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        'Dim ls_layaway As String = "select sum(layaway) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
        Dim ls_layaway As String = "select sum(layaway) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        'Dim ls_salesreturn As String = "select sum(salesreturn) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
        Dim ls_salesreturn As String = "select sum(salesreturn) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013   '
        'Dim ls_layawaycancel As String = "select sum(layawaycancel) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
        Dim ls_layawaycancel As String = "select sum(layawaycancel) from CF_region_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_interest As String = "select sum(interest) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_kppayout As String = "select sum(kp_payout) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_kpsendout As String = "select sum(kp_sendout) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_kpsendoutcomm As String = "select sum(KP_Sendout_Comm) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_lukat As String = "select sum(Lukat) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_otherincome As String = "select sum(OtherIncome) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_Prenda As String = "select sum(prenda) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_telecomms As String = "select sum(telecomms) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_souvenirs As String = "select sum(Souvenirs) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_Corp_Sendout As String = "select sum(Corp_Sendout) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_Corp_Payout As String = "select sum(Corp_Payout) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_Corp_Comm As String = "select sum(Corp_Comm) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_WesternUnionComm As String = "select sum(WesternUnionComm) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '--------------------------------------------------------------
        'updated by Arthur 6/17/2013
        Dim ls_WesternUnionPayout As String = "select sum(WesternUnionPayout) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        'c.DisposeR()
        '--------------------------------------------------------------
        Dim ls_FundTransferDebit As String = "select sum(FundTransferDebit) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        c.DisposeR()
        '----------------------------------------------------------
        Dim ls_FundTransferCredit As String = "select sum(FundTransferCredit) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        c.DisposeR()
        '--------------------------------------------------------------
        Dim ls_BranchExpense As String = "select sum(BranchExpense) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        ...
        c.DisposeR()
        '----------------------------------------------------------
        Dim ls_OtherExpense As String = "select sum(OtherExpense) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '/-added last 2/9/2011
        '----------------------------------------------------------
        Dim ls_nso As String = "select sum(NSO) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_mccr As String = "select sum(MCCashReceipts) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_mccd As String = "select sum(MCCashDisbursements) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_racr As String = "select sum(RACashReceipts) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_racd As String = "select sum(RACashDisbursements) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_dfb As String = "select sum(DepositFromBank) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_wfb As String = "select sum(WithdrawalFromBank) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_rts As String = "select sum(returntosender) from CF_region_vismin where class_02 = 'Visayas' and " & _
        " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        Dim ls_cashover As String = "select isnull(sum(cashover),0) from CF_region_vismin where class_02 = 'Visayas' and " & _
       " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        '----------------------------------------------------------
        '----------------------------------------------------------
        Dim ls_cashshort As String = "select isnull(sum(cashshort),0) from CF_region_vismin where class_02 = 'Visayas' and " & _
       " transdate = '" + transdate + "'"
        If c.ErrorConnectionReading(False) Then Exit Sub
        ...
        If gb_vismin_update = True Then
           ...
           " SET [BeginningBalance]=" & ld_begbal_lv & ", [EndingBalance]=" & ld_endingbal_lv & ", [FoodProducts]=" & ld_foodproducts_lv & ",[Insurance]=" & ld_insurance_lv & ", [outrightsales]=" & ld_outrightsales_lv & ", [layaway]=" & ld_layaway_lv & ", " & _
           " [salesreturn]=" & ld_salesreturn_lv & ", [layawaycancel]=" & ld_layawaycancel_lv & ", [Interest]=" & ld_interest_lv & ", [KP_Payout]= " & ld_kppayout_lv & ", [KP_Sendout]=" & ld_kpsendout_lv & ", [KP_Sendout_Comm]=" & ld_kpsendoutcomm_lv & " , " & _
           " [Lukat]= " & ld_lukat_lv & ", [OtherIncome]= " & ld_otherincome_lv & "  , [Prenda]=" & ld_prenda_lv & " , [Telecomms] = " & ld_telecomms_lv & ", [Souvenirs]=" & ld_souvenirs_lv & ", [Corp_Sendout]=" & ld_corpsendout_lv & ", [Corp_Payout]=" & ld_corppayout_lv & ", " & _
           " [Corp_Comm]=" & ld_corpcomm_lv & " ,[WesternUnionComm]=" & ld_westernUnionComm_lv & ",[WesternUnionPayout]=" & ld_westernunionPayout_lv & ", [WesternUnionSendout]=" & ld_westernunionsendout_lv & ", [FundTransferDebit]=" & ld_fundtransferdebit_lv & ", " & _
           " [FundTransferCredit]=" & ld_fundtransfercredit_lv & ",[BranchExpense]=" & ld_branchexpense_lv & ",[OtherExpense] = " & ld_otherexpense_lv & " ,[NSO] = " & ld_nso_lv & " ,[MCCashReceipts] = " & ld_MCCR_lv & ",[MCCashDisbursements] = " & ld_MCCD_lv & ", " & _
           " [RACashReceipts] = " & ld_RACR_lv & ",[RACashDisbursements] = " & ld_RACD_lv & ",[DepositFromBank] = " & ld_Depositfrombank_lv & " ,[WithdrawalFromBank] = " & ld_withdrawalfrombank_lv & " , [ReturnToSender] = " & ld_returntosender & " ,[cashover] = " & ld_CashOver & " , " & _
           " [cashshort] = " & ld_CashShort & "  ,[dategenerated] = '" + Now.Date + "' WHERE class_02 = 'Visayas' and  transdate = '" + transdate + "' "
            ...
            '\ email functionality added 08-30-2012
        Else
            Dim ls_s As String = "INSERT INTO CF_vismin_wide ([Id],[BeginningBalance], [EndingBalance], [FoodProducts],   [Insurance],  [outrightsales],  [layaway],  [salesreturn],  [layawaycancel],  [Interest], [KP_Payout], [KP_Sendout], [KP_Sendout_Comm], [Lukat], [OtherIncome],[Prenda], " & _
            " [Telecomms], [Souvenirs], [Corp_Sendout], [Corp_Payout], [Corp_Comm], [WesternUnionComm],[WesternUnionPayout],[WesternUnionSendout],[FundTransferDebit], [FundTransferCredit], [BranchExpense], [OtherExpense],[NSO],[MCCashReceipts],[MCCashDisbursements],[RACashReceipts]," & _
            " [RACashDisbursements],[DepositFromBank],[WithdrawalFromBank],[returntosender],[cashover],[cashshort],[Transdate], [DateGenerated], [class_02])" & _
            " VALUES(" & li_idcount & "," & ld_begbal_lv & "," & ld_endingbal_lv & "," & ld_foodproducts_lv & "," & ld_insurance_lv & "," & ld_outrightsales_lv & "," & ld_layaway_lv & "," & ld_salesreturn_lv & "," & ld_layawaycancel_lv & "," & ld_interest_lv & "," & ld_kppayout_lv & "," & _
            " " & ld_kpsendout_lv & ", " & ld_kpsendoutcomm_lv & "," & ld_lukat_lv & ", " & ld_otherincome_lv & ", " & ld_prenda_lv & ", " & ld_telecomms_lv & ", " & ld_souvenirs_lv & ", " & ld_corpsendout_lv & ", " & ld_corppayout_lv & ", " & ld_corpcomm_lv & ", " & ld_westernUnionComm_lv & ", " & _
            " " & ld_westernunionPayout_lv & "," & ld_westernunionsendout_lv & "," & ld_fundtransferdebit_lv & "," & ld_fundtransfercredit_lv & "," & ld_branchexpense_lv & ", " & ld_otherexpense_lv & "," & ld_nso_lv & "," & ld_MCCR_lv & "," & ld_MCCD_lv & "," & ld_RACR_lv & "," & ld_RACD_lv & ", " & _
            " " & ld_Depositfrombank_lv & "," & ld_withdrawalfrombank_lv & "," & ld_returntosender & ", " & ld_CashOver_lv & " , " & ld_CashShort_lv & "  ,'" + transdate + "','" + Now.Date + "', 'Visayas') "
    ...
    Private Sub insert_to_CF_region_vismin()
        ...
        For li_i = 0 To li_listviewcount
            ...
            Dim ls_begbal As String = "select isnull(sum(beginningbalance),0) from CF_area_vismin where class_02 = 'Visayas' and " & _
            ...
            If Not c.Error_SetRdr(ls_begbal, rdr, sqlmsg) Then
                ...
                If rdr.Read Then
                    If IsDBNull(rdr(0)) Then '---Arthur
                        ld_begbal = 0.0
                    Else
                        ld_begbal = CDbl(Trim(rdr(0)))
                        'area beginning balance
                    End If
                End If
            End If
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_endingbal As String = "select isnull (sum(EndingBalance),0) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_endingbal, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_foodproducts As String = "select sum(Foodproducts) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_foodproducts, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_insurance As String = "select sum(Insurance) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_insurance, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------jen
            'Dim ls_outrightsales As String = "select sum(outrightsales) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
            Dim ls_outrightsales As String = "select sum(outrightsales) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "' and class_03 = '" & ls_class03 & "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_outrightsales, rdr, sqlmsg) Then
                If rdr.Read Then
                    If IsDBNull(rdr(0)) Then '---Arthur
            ...
            '----------------------------------------------------------
            'Dim ls_layaway As String = "select sum(layaway) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
            Dim ls_layaway As String = "select sum(layaway) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "' and  class_03 = '" & ls_class03 & "'"
            ...
            '----------------------------------------------------------
            'Dim ls_salesreturn As String = "select sum(salesreturn) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
            Dim ls_salesreturn As String = "select sum(salesreturn) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "' and  class_03 = '" & ls_class03 & "'"
            ...
            c.DisposeR()
            '----------------------------------------------------------------------------------------------------
            'Dim ls_layawaycancel As String = "select sum(layawaycancel) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "','" & "" & "','" & "" & "','" & "" & "'"
            Dim ls_layawaycancel As String = "select sum(layawaycancel) from CF_area_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "' and  class_03 = '" & ls_class03 & "'"
            ...
            Dim ls_interest As String = "select sum(interest) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_interest, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_kppayout As String = "select sum(kp_payout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_kppayout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_kpsendout As String = "select sum(kp_sendout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_kpsendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_kpsendoutcomm As String = "select sum(KP_Sendout_Comm) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_kpsendoutcomm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_lukat As String = "select sum(Lukat) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_lukat, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_otherincome As String = "select sum(OtherIncome) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_otherincome, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_Prenda As String = "select sum(prenda) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Prenda, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_telecomms As String = "select sum(telecomms) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_telecomms, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_souvenirs As String = "select sum(Souvenirs) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_souvenirs, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_Corp_Sendout As String = "select sum(Corp_Sendout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Sendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_Corp_Payout As String = "select sum(Corp_Payout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Payout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_Corp_Comm As String = "select sum(Corp_Comm) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Comm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_WesternUnionComm As String = "select sum(WesternUnionComm) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionComm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_WesternUnionPayout As String = "select sum(WesternUnionPayout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionPayout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_WesternUnionSendout As String = "select sum(WesternUnionSendout) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionSendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_FundTransferDebit As String = "select sum(FundTransferDebit) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_FundTransferDebit, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_FundTransferCredit As String = "select sum(FundTransferCredit) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_FundTransferCredit, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_BranchExpense As String = "select sum(BranchExpense) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_BranchExpense, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_OtherExpense As String = "select sum(OtherExpense) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_OtherExpense, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '/-added last 2/9/2011
            '----------------------------------------------------------
            Dim ls_NSO As String = "select sum(NSO) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_NSO, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_MCCR As String = "select sum(MCCashReceipts) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_MCCR, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_MCCD As String = "select sum(MCCashDisbursements) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_MCCD, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_RACR As String = "select sum(RACashReceipts) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_RACR, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_RACD As String = "select sum(RACashDisbursements) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_RACD, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_DFB As String = "select sum(DepositFromBank) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_DFB, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_WFB As String = "select sum(WithdrawalFromBank) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WFB, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_rts As String = "select sum(returntosender) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_rts, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '\-added last 2/9/2011
            '/-added last 7/26/2011
            Dim ls_cashover As String = "select sum(cashover) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_cashover, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            Dim ls_cashshort As String = "select sum(cashshort) from CF_area_vismin where class_02 = 'Visayas' and " & _
            "class_03 = '" + ls_class03 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_cashshort, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            If gb_region_update = True Then
                ...
                " [Corp_Comm]=" & ld_corpcomm_lv & " ,[WesternUnionComm]=" & ld_westernUnionComm_lv & ", [WesternUnionPayout]=" & ld_westernunionPayout_lv & ", [WesternUnionSendout]=" & ld_westernunionsendout_lv & ", [FundTransferDebit]=" & ld_fundtransferdebit_lv & ", " & _
                " [FundTransferCredit]=" & ld_fundtransfercredit_lv & ", [BranchExpense]=" & ld_branchexpense_lv & ",[OtherExpense] = " & ld_otherexpense_lv & " ,[NSO] = " & ld_nso_lv & " ,[MCCashReceipts] = " & ld_MCCR_lv & ",[MCCashDisbursements] = " & ld_MCCD_lv & ", " & _
                " [RACashReceipts] = " & ld_RACR_lv & ",[RACashDisbursements] = " & ld_RACD_lv & ",[DepositFromBank] = " & ld_Depositfrombank_lv & " ,[WithdrawalFromBank] = " & ld_withdrawalfrombank_lv & ",[returntosender] = " & ld_returntosender_lv & "  ,[cashover] = " & ld_cashover_lv & ", " & _
                " [cashshort] = " & ld_cashshort_lv & "  ,[dategenerated] = '" + Now.Date + "' WHERE class_02 = 'Visayas' and class_03 = '" + class03 + "' and  transdate = '" + transdate + "' "
            ...
            Else
                Dim ls_s As String = "INSERT INTO CF_region_vismin ([Id],[Class_03], [BeginningBalance], [EndingBalance], [FoodProducts],   [Insurance] ,  [outrightsales],  [layaway],  [salesreturn],  [layawaycancel], [Interest], [KP_Payout], [KP_Sendout], [KP_Sendout_Comm], [Lukat], [OtherIncome],[Prenda], " & _
                " [Telecomms], [Souvenirs], [Corp_Sendout], [Corp_Payout], [Corp_Comm], [WesternUnionComm],[WesternUnionPayout],[WesternUnionSendout],[FundTransferDebit], [FundTransferCredit], [BranchExpense], [OtherExpense],[NSO],[MCCashReceipts],[MCCashDisbursements],[RACashReceipts], " & _
                " [RACashDisbursements],[DepositFromBank],[WithdrawalFromBank],[returntosender],[cashover],[cashshort],[Transdate], [DateGenerated], [class_02])" & _
                " VALUES(" & li_idcount & ",'" + class03 + "', " & ld_begbal_lv & "," & ld_endingbal_lv & "," & ld_foodproducts_lv & "," & ld_insurance_lv & "," & ld_outrightsales_lv & "," & ld_layaway_lv & "," & ld_salesreturn_lv & "," & ld_layawaycancel_lv & "," & ld_interest_lv & "," & ld_kppayout_lv & ", " & _
                " " & ld_kpsendout_lv & ", " & ld_kpsendoutcomm_lv & "," & ld_lukat_lv & ", " & ld_otherincome_lv & ", " & ld_prenda_lv & ", " & ld_telecomms_lv & ", " & ld_souvenirs_lv & ", " & ld_corpsendout_lv & ", " & ld_corppayout_lv & ", " & ld_corpcomm_lv & ", " & ld_westernUnionComm_lv & ", " & _
                " " & ld_westernunionPayout_lv & "," & ld_westernunionsendout_lv & "," & ld_fundtransferdebit_lv & "," & ld_fundtransfercredit_lv & "," & ld_branchexpense_lv & ", " & ld_otherexpense_lv & " ," & ld_nso_lv & "," & ld_MCCR_lv & "," & ld_MCCD_lv & "," & ld_RACR_lv & "," & ld_RACD_lv & ", " & _
                " " & ld_Depositfrombank_lv & "," & ld_withdrawalfrombank_lv & "," & ld_returntosender_lv & "," & ld_cashover_lv & ", " & ld_cashshort_lv & "  ,'" + transdate + "','" + Date.Now + "', 'Visayas') "
    ...
    Private Sub insertion_to_cf_pb_vismin()
        ...
        For li_i = 0 To li_listviewcount
            ...
            Dim ls_OtherExpenseNotRMBase As String = "select  sum(totalotherexpensenotRMBase) from vwCashFlowOtherExpenseNotRMBase_CF_ver3  where branchcode = '" + bcode + "' and transdate ='" + transdate + "' and rmbase_CostCenter = '0" + bcode + "-" + bcode + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            ...
            " where transdate = '" + transdate + "' and branchcode = '" + bcode + "')x where totalcashdisbursements > 0"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_mccd, rdr, sqlmsg) Then
                If rdr.Read Then
                    'ld_otherincome = Trim(rdr(0)) 'area otherincome
            ...
            Try
                If gb_pb_update = True Then
                    ...
                    " [FundTransferCredit]=" & ld_fundtransfercredit_lv & ", [BranchExpense]=" & ld_branchexpense_lv & ",[OtherExpense] = " & ld_otherexpense_lv & " ,[NSO] = " & ld_nso_lv & " ,[MCCashReceipts] = " & ld_MCCR_lv & ",[MCCashDisbursements] = " & ld_MCCD_lv & ", " & _
                    " [RACashReceipts] = " & ld_RACR_lv & ",[RACashDisbursements] = " & ld_RACD_lv & ",[DepositFromBank] = " & ld_Depositfrombank_lv & " ,[WithdrawalFromBank] = " & ld_withdrawalfrombank_lv & ",[ReturnToSender] = " & ld_returntosender_lv & " , [Cashover] = " & ld_CashOver_lv & " , " & _
                    " [cashshort] = " & ld_CashShort_lv & "  ,[dategenerated] = '" + Now.Date + "' WHERE class_02 = 'Visayas' and branchcode = '" + bcode + "' and transdate = '" + transdate + "' "
                    ...
                    c26.DisposeR()
                Else
                    Dim ls_s As String = "INSERT INTO CF_PB_vismin ([Id],[branchcode],[branchname],[Class_03], [Class_04], [BeginningBalance], [EndingBalance], [FoodProducts],   [Insurance],  [outrightsales],  [layaway],  [salesreturn],  [layawaycancel], [Interest], [KP_Payout], [KP_Sendout], [KP_Sendout_Comm], " & _
                    " [Lukat], [OtherIncome], [Prenda], [Telecomms], [Souvenirs], [Corp_Sendout], [Corp_Payout], [Corp_Comm], [WesternUnionComm],[WesternUnionPayout],[WesternUnionSendout],[FundTransferDebit], [FundTransferCredit], [BranchExpense], [OtherExpense],[NSO],[MCCashReceipts],[MCCashDisbursements],[RACashReceipts], " & _
                    " [RACashDisbursements],[DepositFromBank],[WithdrawalFromBank], [ReturnToSender],[cashover],[cashshort] ,[Transdate], [DateGenerated], [class_02])" & _
                    " VALUES(" & li_idcount & ",'" + bcode + "','" + branchname + "','" + class03 + "', '" + ls_class04 + "', " & ld_begbal_lv & "," & ld_endingbal_lv & "," & ld_foodproducts_lv & "," & ld_insurance_lv & "," & ld_outrightsales_lv & ", " & ld_layaway_lv & ", " & ld_salesreturn_lv & ", " & ld_layawaycancel_lv & ", " & _
                    " " & ld_interest_lv & ", " & ld_kppayout_lv & ", " & ld_kpsendout_lv & ", " & ld_kpsendoutcomm_lv & "," & ld_lukat_lv & ", " & ld_otherincome_lv & ", " & ld_prenda_lv & ",  " & ld_telecomms_lv & ", " & ld_souvenirs_lv & ", " & ld_corpsendout_lv & ", " & ld_corppayout_lv & ", " & ld_corpcomm_lv & ", " & ld_westernUnionComm_lv & ", " & _
                    " " & ld_westernunionPayout_lv & "," & ld_westernunionsendout_lv & "," & ld_fundtransferdebit_lv & "," & ld_fundtransfercredit_lv & "," & ld_branchexpense_lv & ", " & ld_otherexpense_lv & "," & ld_nso_lv & "," & ld_MCCR_lv & "," & ld_MCCD_lv & "," & ld_RACR_lv & "," & ld_RACD_lv & "," & ld_Depositfrombank_lv & "," & ld_withdrawalfrombank_lv & ", " & _
                    " " & ld_returntosender_lv & ", " & ld_CashOver_lv & " ," & ld_CashShort_lv & " ,'" + transdate + "','" + Now.Date + "','Visayas') "
    ...
    Private Sub insert_to_CF_area_vismin()
        ...
        For li_i = 0 To li_listviewcount
            ...
            'code starts here-------------------------------------------------------------------
            Dim ls_begbal As String = "select sum(beginningbalance) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_endingbal As String = "select sum(EndingBalance) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_endingbal, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_foodproducts As String = "select sum(Foodproducts) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_foodproducts, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_insurance As String = "select sum(Insurance) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_insurance, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            Dim ls_outrightsales As String = "select sum(outrightsales) from CF_pb_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'and class_04 = '" & ls_class04 & "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_outrightsales, rdr, sqlmsg) Then
                If rdr.Read Then
                    If IsDBNull(rdr(0)) Then '---Arthur
            ...
            c.DisposeR()
            '-------------------------------- 
            Dim ls_layaway As String = "select sum(layaway) from CF_pb_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'and class_04 = '" & ls_class04 & "'"
            ...
            c.DisposeR()
            '--------------------------------
            Dim ls_salesreturn As String = "select sum(salesreturn) from CF_pb_vismin where class_02 = 'Visayas' and transdate =  '" & transdate & "'and class_04 = '" & ls_class04 & "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_salesreturn, rdr, sqlmsg) Then
                If rdr.Read Then
                    If IsDBNull(rdr(0)) Then '---Arthur
            ...
            '----------------------------------------------------
            Dim ls_layawaycancel As String = "select sum(layawaycancel) from CF_pb_vismin  where class_02 = 'Visayas' and transdate =  '" & transdate & "'and class_04 = '" & ls_class04 & "'"
            ...
            '---------------------------------------------------------------------------------------
            Dim ls_interest As String = "select sum(interest) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_interest, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_kppayout As String = "select sum(kp_payout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_kpsendout As String = "select sum(kp_sendout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_kpsendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_kpsendoutcomm As String = "select sum(KP_Sendout_Comm) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_kpsendoutcomm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_lukat As String = "select sum(lukat) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_lukat, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_otherincome As String = "select sum(OtherIncome) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_otherincome, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_Prenda As String = "select sum(prenda) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Prenda, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_telecomms As String = "select sum(telecomms) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_telecomms, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_souvenirs As String = "select sum(Souvenirs) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_souvenirs, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_Corp_Sendout As String = "select sum(Corp_Sendout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Sendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_Corp_Payout As String = "select sum(Corp_Payout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Payout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_Corp_Comm As String = "select sum(Corp_Comm) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_Corp_Comm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_WesternUnionComm As String = "select sum(WesternUnionComm) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionComm, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_WesternUnionPayout As String = "select sum(WesternUnionPayout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionPayout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_WesternUnionSendout As String = "select sum(WesternUnionSendout) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_WesternUnionSendout, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_FundTransferDebit As String = "select sum(FundTransferDebit) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_FundTransferDebit, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_FundTransferCredit As String = "select sum(FundTransferCredit) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_FundTransferCredit, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '--------------------------------------------------------------
            Dim ls_BranchExpense As String = "select sum(BranchExpense) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_BranchExpense, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            c.DisposeR()
            '----------------------------------------------------------
            Dim ls_OtherExpense As String = "select sum(OtherExpense) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_OtherExpense, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            Dim ls_nso As String = "select sum(NSO) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_nso, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_mccr As String = "select sum(MCCashReceipts) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_mccr, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_mccd As String = "select sum(MCCashDisbursements) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_mccd, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_racr As String = "select sum(RACashReceipts) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_racr, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_racd As String = "select sum(RACashDisbursements) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_racd, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_dfb As String = "select sum(DepositFromBank) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_dfb, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_wfb As String = "select sum(WithdrawalFromBank) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_wfb, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            '----------------------------------------------------------
            Dim ls_rts As String = "select sum(ReturnToSender) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_rts, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '\-added last 7/26/2011
            '----------------------------------------------------------
            Dim ls_cashover As String = "select sum(cashover) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_cashover, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            '----------------------------------------------------------
            Dim ls_cashshort As String = "select sum(cashshort) from CF_pb_vismin where class_02 = 'Visayas' and " & _
            "class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "'"
            If c.ErrorConnectionReading(False) Then Exit Sub
            If Not c.Error_SetRdr(ls_cashshort, rdr, sqlmsg) Then
                If rdr.Read Then
            ...
            If gb_area_update = True Then
                ...
                " SET [BeginningBalance]=" & ld_begbal_lv & ", [EndingBalance]=" & ld_endingbal_lv & ", [FoodProducts]=" & ld_foodproducts_lv & ",[Insurance]=" & ld_insurance_lv & ",[outrightsales]=" & ld_outrightsales & ",[layaway]=" & ld_layaway & ", " & _
                " [salesreturn]=" & ld_salesreturn & ",[layawaycancel]=" & ld_layawaycancel & ", [Interest]=" & ld_interest_lv & ",  [KP_Payout]= " & ld_kppayout_lv & ", [KP_Sendout]=" & ld_kpsendout_lv & ", [KP_Sendout_Comm]=" & ld_kpsendoutcomm_lv & " , " & _
                " [Lukat]= " & ld_lukat_lv & ", [OtherIncome]= " & ld_otherincome_lv & "  , [Prenda]=" & ld_prenda_lv & " , [Telecomms] = " & ld_telecomms_lv & ", [Souvenirs]=" & ld_souvenirs_lv & ", [Corp_Sendout]=" & ld_corpsendout_lv & ", " & _
                " [Corp_Payout]=" & ld_corppayout_lv & ",[Corp_Comm]=" & ld_corpcomm_lv & " ,[WesternUnionComm]=" & ld_westernUnionComm_lv & ", [WesternUnionPayout]=" & ld_westernunionPayout_lv & ", [WesternUnionSendout]=" & ld_westernunionsendout_lv & ", " & _
                " [FundTransferDebit]=" & ld_fundtransferdebit_lv & ", [FundTransferCredit]=" & ld_fundtransfercredit_lv & ", [BranchExpense]=" & ld_branchexpense_lv & ",[OtherExpense] = " & ld_otherexpense_lv & " ,[NSO] = " & ld_nso_lv & " ,[MCCashReceipts] = " & ld_MCCR_lv & ", " & _
                " [MCCashDisbursements] = " & ld_MCCD_lv & ",[RACashReceipts] = " & ld_RACR_lv & ",[RACashDisbursements] = " & ld_RACD_lv & ", [DepositFromBank] = " & ld_Depositfrombank_lv & " , [WithdrawalFromBank] = " & ld_withdrawalfrombank_lv & ",[ReturnToSender] = " & ld_returntosender_lv & " , " & _
                " [cashover] = " & ld_cashover_lv & "  ,[cashshort] = " & ld_cashshort_lv & "  ,[dategenerated] = '" + Now.Date + "' WHERE class_02 = 'Visayas' and class_04 = '" + ls_class04 + "' and transdate = '" + transdate + "' "
                ...
                c.DisposeR()
            Else
                Dim ls_s As String = "INSERT INTO CF_AREA_vismin ([Id],[Class_03], [Class_04], [BeginningBalance], [EndingBalance], [FoodProducts],   [Insurance],  [outrightsales],  [layaway],  [salesreturn],  [layawaycancel],  [Interest], [KP_Payout], [KP_Sendout], [KP_Sendout_Comm], [Lukat], [OtherIncome],[Prenda], " & _
                " [Telecomms], [Souvenirs], [Corp_Sendout], [Corp_Payout], [Corp_Comm], [WesternUnionComm],[WesternUnionPayout],[WesternUnionSendout],[FundTransferDebit], [FundTransferCredit], [BranchExpense], [OtherExpense],[NSO],[MCCashReceipts],[MCCashDisbursements],[RACashReceipts],[RACashDisbursements], " & _
                " [DepositFromBank],[WithdrawalFromBank],[ReturnToSender],[cashover],[cashshort], [Transdate], [DateGenerated], [class_02])" & _
                " VALUES(" & li_idcount & ",'" + class03 + "', '" + ls_class04 + "', " & ld_begbal_lv & "," & ld_endingbal_lv & "," & ld_foodproducts_lv & "," & ld_insurance_lv & "," & ld_outrightsales & "," & ld_layaway & "," & ld_salesreturn & "," & ld_layawaycancel & "," & ld_interest_lv & "," & ld_kppayout_lv & ", " & _
                " " & ld_kpsendout_lv & ", " & ld_kpsendoutcomm_lv & "," & ld_lukat_lv & ", " & ld_otherincome_lv & ", " & ld_prenda_lv & ", " & ld_telecomms_lv & ", " & ld_souvenirs_lv & ", " & ld_corpsendout_lv & ", " & ld_corppayout_lv & ", " & ld_corpcomm_lv & ", " & ld_westernUnionComm_lv & ", " & ld_westernunionPayout_lv & ", " & _
                " " & ld_westernunionsendout_lv & "," & ld_fundtransferdebit_lv & "," & ld_fundtransfercredit_lv & "," & ld_branchexpense_lv & ", " & ld_otherexpense_lv & "," & ld_nso_lv & "," & ld_MCCR_lv & "," & ld_MCCD_lv & "," & ld_RACR_lv & "," & ld_RACD_lv & "," & ld_Depositfrombank_lv & "," & ld_withdrawalfrombank_lv & ", " & _
                " " & ld_returntosender_lv & "," & ld_cashover_lv & ", " & ld_cashshort_lv & " ,'" + transdate + "','" + Now.Date + "', 'Visayas') "
    ...
    Private Sub select_per_branch()
        ...
        Dim ls_s As String = "select bedrnr,bedrnm,class_03,class_04, class_02 from bedryf where class_02 = 'Visayas' order by class_04 asc"
        Dim c As New ClsVisayas
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub select_region()
        ...
        Dim jobtitle As String = Nothing
        'updated by Arthur 6/17/13
        Dim ls_s As String = "select distinct class_03, class_02 from bedryf where class_02 = 'Visayas' order by class_03 asc"
        Dim c As New ClsVisayas
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub select_area()
        ...
        Dim jobtitle As String = Nothing
        'updated by Arthur 6/17/13
        Dim ls_s As String = "select distinct class_03,class_04, class_02 from bedryf where class_02 = 'Visayas' order by class_04 asc"
        Dim c As New ClsVisayas
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub id_count_vismin_wide()
        ...
        Dim username As String = Nothing
        Dim jobtitle As String = Nothing
        Dim ls_s As String = "select count(id) from cf_vismin_wide"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub id_count_region_vismin()
        ...
        Dim username As String = Nothing
        Dim jobtitle As String = Nothing
        Dim ls_s As String = "select count(id) from cf_region_vismin"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub id_count_area_vismin()
        ...
        Dim username As String = Nothing
        Dim jobtitle As String = Nothing
        Dim ls_s As String = "select count(id) from cf_area_vismin"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub id_count_pb_vsimin()
        ...
        Dim username As String = Nothing
        Dim jobtitle As String = Nothing
        Dim ls_s As String = "select count(id) from cf_pb_vismin"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
...
" where class_02 = 'Visayas' and transdate = '" + transdate + "' and branchcode = '" + gs_bcode + "'"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
    ...
    Private Sub area_transdate_exist()
        ...
        Dim ls_s As String = "select distinct transdate from cf_area_vismin " & _
" where class_02 = 'Visayas' and transdate = '" + transdate + "' and class_04 = '" + gs_class04 + "'"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
...
" where class_02 = 'Visayas' and transdate = '" + transdate + "' and class_03 = '" + gs_class03 + "'"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
...
" where class_02 = 'Visayas' and transdate = '" + transdate + "'"
        Dim c As New clsData
        If c.Error_Inititalize_INI Then Exit Sub
        If c.ErrorConnectionReading(False) Then Exit Sub
        If Not c.Error_SetRdr(ls_s, rdr, sqlmsg) Then
