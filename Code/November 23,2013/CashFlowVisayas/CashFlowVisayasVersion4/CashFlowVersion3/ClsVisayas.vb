Public Class ClsVisayas
    ...
    Public Function errorConnectionWriting() As Boolean
        Try
            ...
            connW.ConnectionString = "data source = " & server & "; initial catalog = " & db & _
                "; user id = " & ui & "; password = " & pass & "; pooling = false; Connect Timeout=3600;"
            connW.Open()
    ...
    Public Function Error_Inititalize_INI() As Boolean
        Try
            Dim sr As New IO.StreamReader(Application.StartupPath & "\CashFlowVisayas.ini")
